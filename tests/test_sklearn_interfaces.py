...
@parametrize_with_checks([
    ...
    # TabM_D_Classifier(tabm_k=2, num_emb_type='pwl', arch_type='tabm-mini', num_emb_n_bins=2),
    # TabM_D_Regressor(tabm_k=2, num_emb_type='pwl', arch_type='tabm-mini', num_emb_n_bins=2),
    ...
    # FTT_D_Classifier(module_d_token=128, module_n_heads=8, max_epochs=32),
    # FTT_D_Regressor(module_d_token=128, module_n_heads=8, max_epochs=32),
